    ...
    <div class="col-md-9 col-lg-7">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form
                    method="POST"
                    action="{{ route('admin.buku.update', $buku) }}"
                ...
                >
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            {{-- Cover Cloudinary yang sekarang --}}
                            @if($buku->gambar)
                                <div class="mb-2">
                                    <label class="form-label fw-normal text-muted small mb-1">
                                        Cover saat ini:
                                    </label>
                            ...
                            <small class="text-muted d-block mt-1">
                                ...
                                Biarkan kosong untuk mempertahankan cover lama.
                            </small>
                        </div>
