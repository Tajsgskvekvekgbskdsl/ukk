    ...
    <nav class="navbar navbar-expand-lg site-navbar">
        <div class="site-container">
            <a class="site-brand me-auto" href="{{ route('beranda') }}">
                ...
                <span class="brand-text">Perpustakaan Sekolah</span>
            </a>
            ...
            <div class="row gy-4">
                <div class="col-md-5">
                    ...
                    <p class="mb-0" style="max-width: 320px;">
                        Jendela ilmu bagi siswa dan guru. Cari buku lewat katalog daring,
                        pinjam dengan mudah, dan tingkatkan minat baca bersama.
                    </p>
                </div>
                ...
                <div class="col-md-4 col-6">
                    <h6>Kontak</h6>
                    <ul>
                        <li><i class="bi bi-geo-alt me-2" style="color:#16C94A;"></i>Jl. Pendidikan No. 17</li>
                        <li class="mt-2"><i class="bi bi-envelope me-2" style="color:#16C94A;"></i><a href="mailto:perpus@sekolah.sch.id">perpus@sekolah.sch.id</a></li>
                    </ul>
                </div>
            </div>
            <div class="footer-bottom">
                &copy; {{ date('Y') }} Perpustakaan Sekolah — Dibangun untuk siswa &amp; guru.
            </div>
        </div>
    </footer>
